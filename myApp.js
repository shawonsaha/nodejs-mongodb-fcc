...
var createAndSavePerson = function(done) {
  var shawon = new Person({
    name: "shawon",
    age: 23,
    favoriteFoods: ["alu", "singara"]
  });
  shawon
    .save()
...
/* oh... i am still confused with done()... can you suggest me some refference ?
I am a noob... dont know much about callback either :(

just look here: https://stackoverflow.com/questions/28656780/what-is-the-attribute-done-in-nodejs
Oh! thats what i am looking for... thanks a lot
Got it
*/
...
var arrayOfPeople = [
  { name: "shawon", age: 23, favoriteFoods: ["alu", "singara"] },
  { name: "fahim", age: 23, favoriteFoods: ["gaja", "samucha"] }
];
